...
<head>
    ...
    if (isset($_REQUEST["btnupdmed"])) {
        ...
        if (mysqli_num_rows($t) > 0) {
            $updprd = "UPDATE product SET prdnm='$prdnm', prdpri='$prdpri',stock='$prdstock' where prdid = '$prdid'";
    ...
    <div class="form-container" method="post">
        ...
        <form id="loginForm" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img src="./medimage/<?php getdata();
                                        echo $prdimg ?>" alt="prdimg" width="30%" height="100px">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="prdunit" name="prdunit" value="<?php getdata();
                                                                                            echo $prdunit ?>" required>
            </div>
